...
<%
    /* {VARIABEL} */
    String vHTMLGambarIcon = "berita.png";
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/publik/modul/modModalDaftarBerita" prefix="publik" %>
<publik:modal>
  ...
  <jsp:attribute name="isi">
    <div class="clsModalIsiTabel700">
        <div class="clsModalJudulTabel700">
            <button type="button" class="close" onclick="Custombox.close('idDaftarBerita');">&times;</button>
            <h4><img src="${URLModAdpubGambarMenu}/${vHTMLGambarIcon}"/> &nbsp; <strong>${vHTMLOperasi} ${vModKonfNamaData}</strong></h4>
        </div>

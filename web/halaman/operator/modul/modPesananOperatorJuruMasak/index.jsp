...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/operator/modul/modPesananOperatorJuruMasak" prefix="operator" %>
<operator:index>
                    ...
                    <td class="clsTdJudul">
                        <table id="idTabelJudulModul">
                            <tr>
                                ...
                                <td class="clsTdJudulMod">Pesanan Operator Juru Masak</td>
                            </tr>
                        </table>
                    </td>
                </tr>

...
<% 
    ...
    String vGetKodeOrang = oOlahKata.fHapusSpasi(request.getParameter("p"));
    request.setAttribute("vGetKodeOrang", vGetKodeOrang);
    
    /* ambil nama orang */
    ClsOperasiBasisdata oOpsBasisdata = new ClsOperasiBasisdata();
    
    String vNamaOrang = oOpsBasisdata.fAmbilSatuData("", "", 
            "tb_sipil_orang", "nama_lengkap", "kode", vGetKodeOrang);
    request.setAttribute("vNamaOrang", vNamaOrang);
%>
            ...
            $(document).ready(function() {
                ...
                $('#idTambah48').click(function(e) {
                    ...
                    Custombox.open({
                        ...
                        target: '${URLModAdmin}/modSipilModalUploadFotoOrang/modal.jsp?o=t&p=${vGetKodeOrang}&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        overlayClose: false
                    });
                ...
                $(document).on('click', '.clsTombolUbah', function(e){ 
                   //alert($(this).attr("value"));
                    ...
                    var vKodeFotoOrang = $(this).attr("value");
                                        
                    /* menampilkan halaman dalam bentuk modal */
                    Custombox.open({
                        target: '${URLMod}/modal.jsp?o=u&p=' + vKodeOrang + '&k=' + vKodeFotoOrang + '&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        width: 380,
                        cache: false,
                ...
                $(document).on('click', '.clsTombolHapus', function(e){ 
                   //alert($(this).attr("value"));
                    ...
                    var vKodeFotoOrang = $(this).attr("value");
                    Custombox.open({
                        target: '${URLMod}/modal.jsp?o=h&p=' + vKodeOrang + '&k=' + vKodeFotoOrang + '&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        width: 380,
                        cache: false,
                ...
                $("#idHapus32").click(function(e){
                    ...
                    if(vSemuaKode != ""){
                        ...
                        /* menampilkan modal */
                        Custombox.open({
                            target: '${URLMod}/modal.jsp?o=h&p=' + vKodeOrang + '&k=' + encodeURIComponent(vSemuaKode) + '&w=' + vWaktu,
                            effect: 'slide',
                            animation: 'top,top',
                            width: 380,
                            cache: false,
                            ...
                            $.each(oData,function(id,el){
                                ...
                                var vFoto = '<div id=\"idDivKotakFoto\" class=\"clsDivKotakFoto wobble-vertical\">' + 
                                                '<div id=\"idDivBerkasFoto\" class=\"clsDivBerkasFoto\" >' +
                                                    '<img id=\"idBerkasFoto\" class=\"clsBerkasFoto\" src=\"' + '${URLModAdpubFoto}' + '/orang/t' + el.berkas + el.ekstensi + '\" alt=\"' + i + '\" />' +
                ...
                function fStatusAdaDlmArray(vFAnggotaBaru, vFArray){
                    ...
                    for(i=0;i<vArrFaktor.length;i++){
                        if(vBoolPertama){
                            ...
                            vOrang = vArrFaktor[i] * vOrang;
                        }
                        //console.log("vOrang: " + vOrang);
                    }
                    
                    return (vOrang==0)?true:false;
                }
                        ...
                        <table id="idTabelJudulModul">
                            <tr>
                                <td class="clsTdGambar">
                                    <a href="${URLModAdmin}/modSipilOrang/index.jsp">
                                        <button class="clsTombolMenuBalik grow">
                                            <img src="${URLModAdpubGambarTombol}/tombolBalik48.png"/>
                                        </button>
                                    </a>
                                </td>
                                <td class="clsTdJudulMod">Administrasi Data ${vModKonfNamaData} <br>${vGetKodeOrang} - ${vNamaOrang}</td>
                            </tr>
                        </table>
                    </td>
                </tr>

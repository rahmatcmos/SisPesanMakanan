...
<% 
    ...
    String vPostKodeOrang = oKata.fHapusSpasi(request.getParameter("dtKodeOrang"));
    ...
    */
    ...
    if(vTeksCari.trim().equals("")){
        ...
        vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                ...
                new String[]{"kode_sipil_orang",vPostKodeOrang},
                "nomor", 
                vUrutanData, 
    ...
    if(!vTeksCari.trim().equals("")){
        ...
        vJumDataTotal = oOpsBasisdata.fJumDataTotalKondisiArr("", 
                ...
                vNamaTabel, 
                new String[]{"kode"}, 
                new String[]{vKolomCari,"kode_sipil_orang"}, 
                new String[]{vTeksCari,vPostKodeOrang}, 
                new String[]{"%LIKE%","="},
                new String[]{"AND"}
                );
        /* keluaran pencarian */

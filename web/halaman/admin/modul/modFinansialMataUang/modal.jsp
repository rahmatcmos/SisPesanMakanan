...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","singkatan","kode_geo_negara","catatan"}, 
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Singkatan","Negara","Catatan"}, 
            new String[]{"!Kode", "Nama","Singkatan","KodeNegara","Catatan"}, 
            new String[]{"@t","@t","@t","s","a"}, 
            new String[]{vKode,vNama,vSingkatan,vSelNegara,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modFinansialMataUang" prefix="admin" %>
<admin:modal>

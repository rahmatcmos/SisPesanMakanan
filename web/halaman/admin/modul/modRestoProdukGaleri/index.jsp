...
<% 
    ...
    String vGetKodeProduk = oOlahKata.fHapusSpasi(request.getParameter("p"));
                        ...
                        <table id="idTabelJudulModul">
                            <tr>
                                <td class="clsTdGambar">
                                    <a href="${URLModAdmin}/modRestoProduk/index.jsp">
                                        <button class="clsTombolMenuBalik grow">
                                            <img src="${URLModAdpubGambarTombol}/tombolBalik48.png"/>
                                        </button>
                                    </a>
                                </td>
                                <td class="clsTdJudulMod">Administrasi Data ${vModKonfNamaData} <br>Produk: ${vGetKodeProduk} - ${vNamaProduk}</td>
                            </tr>
                        </table>
                    </td>
                </tr>

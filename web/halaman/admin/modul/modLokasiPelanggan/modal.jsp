    ...
    try{
        if(session.getAttribute("sesIDPub") != ""){
            ...
            if(vSandiDB.equals(vSandiSesi)){
                String vKodeOrang = oOpsBasisdataSesi.fAmbilSatuData("", "", "tb_pelanggan", "kode_orang", "email", vIdSesi);
...
<%
    ...
    /* {OPERASI DATA} */
    vKodeOrang = oOpsBasisdata.fAmbilSatuData("", "", "tb_pelanggan", "kode_orang", "kode", vGetKodeOrang);
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modLokasiPelanggan" prefix="admin" %>
<admin:modal>

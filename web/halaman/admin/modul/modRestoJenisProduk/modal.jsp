...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","catatan","kode_kategori_produk"}, 
        ...
        while(vArrHasil.next()){
            ...
            vKodeKategoriProduk = vArrHasil.getString("kode_kategori_produk");
        }
        /* gambar icon */
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        if(vGetOperasi.equals("t")){
            /* 1) negara */
            vSelNegara = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_kategori_produk", "");
        }
        
        /* B) operasi ubah data */
        if(vGetOperasi.equals("u")){
            /* 1) negara */
            vSelNegara = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_kategori_produk", vKodeKategoriProduk);
        }
        /* -------------------------------- */
        
        /* {FORM} */
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Kategori Produk","Catatan"}, 
            new String[]{"!Kode", "Nama","KodeKategoriProduk","Catatan"}, 
            new String[]{"@t","@t","s","a"}, 
            new String[]{vKode,vNama,vSelNegara,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modRestoJenisProduk" prefix="admin" %>
<admin:modal>

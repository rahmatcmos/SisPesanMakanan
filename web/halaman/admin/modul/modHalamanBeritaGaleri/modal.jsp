...
<%
    ...
    if(vGetOperasi.equals("u")){
        vHTMLOperasi = "Ubah";
        vGetKodeFotoBerita = oKata.fHapusSpasi(request.getParameter("k"));
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisiArr("", 
                ...
                new String[]{"kode","kode_hlm_berita"},
                new String[]{vGetKodeFotoBerita,vGetKodeBerita},
    ...
    if(vGetOperasi.equals("h")){
        ...
        vHTMLForm = oForm.fFormYaTidak("POST","#",vKalimat, 
                ...
                "idForm", 
                "clsForm",
                new String[]{"idKodeFotoBerita",vGetKodeHapus});
    }
	...
	<script type="text/javascript">
            ...
            //<![CDATA[
                $(document).ready(function() {
                    /* {VARIABEL GLOBAL} */
                    var vTgl = new Date();
                    var vWaktu, vOperasi, vKodeBerita, vKodeFotoBerita; /* data yang dikirim */
                    ...
                    $('#idTombolYa').click(function(e){
                        ...
                        vKodeBerita = '${vGetKodeBerita}';
                        vKodeFotoBerita = $('#idKodeFotoBerita').val();

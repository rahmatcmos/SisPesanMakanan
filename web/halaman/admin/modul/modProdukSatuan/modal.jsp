...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","singkatan","catatan"}, 
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Singkatan","Catatan"}, 
            new String[]{"!Kode", "Nama","Singkatan","Catatan"}, 
            new String[]{"@t","@t","@t","a"}, 
            new String[]{vKode,vNama,vSingkatan,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modProdukSatuan" prefix="admin" %>
<admin:modal>

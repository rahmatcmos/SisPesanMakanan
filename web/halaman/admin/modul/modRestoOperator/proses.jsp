...
<%
    ...
    if(!vOperasi.equals("")){
        ...
        if(vOperasi.equals("t")){
            ...
            vKodeKaryawan = oKata.fHapusSpasi(request.getParameter("dtKodeKaryawan").toString());
            vNama = oKata.fSatuSpasi(request.getParameter("dtNama").toString());
            vKodeJenisOperator = oKata.fSatuSpasi(request.getParameter("dtKodeJenisOperator").toString()).substring(0,8);
            ...
            /* enkripsi sandi dalam bentuk hash */
            ...
            if(!vKode.equals("") && !vNama.equals("")){
                ...
                oOpsBasisdata.fOperasiBdDasar("",
                        ...
                        new String[]{"kode"}, 
                        new String[]{vKode},
                        new String[]{"null",vKode,vNama,vSandiEnkripsi,vCatatan,vKodeKaryawan,vKodeJenisOperator,vAktif}, "t",true);
        ...
        if(vOperasi.equals("u")){
            ...
            /* ambil sandi dibasis data */
            String vSandiBd = oOpsBasisdata.fAmbilSatuData("", vModKonfNamaBd, 
                    vModKonfNamaTabel,"sandi", "kode", vKode);
            
            /* enkripsi sandi dalam bentuk hash */
            ClsSHA oSHA = new ClsSHA(); 
            String vSandiEnkripsi = "null";
            /* bila ada perubahan sandi */
            if(!vSandiBd.equals(vSandi)){
                vSandiEnkripsi = oSHA.fSHA256(vSandi);
            }
            ...
            if(!vKode.equals("") && !vNama.equals("")){
                oOpsBasisdata.fOperasiBdDasar("", 
                    ...
                    new String[]{"null",vKode,vNama,vSandiEnkripsi,vCatatan,vKodeKaryawan,vKodeJenisOperator,vAktif}, 
                    "u",
                    true);
        ...
        if(vOperasi.equals("s")){
            ...
            if(vPostKodeData.equals("pekerjaan")){
                String vKodeKaryawanRef = vPostKodeRef.substring(0,8);
                ResultSet vArrDataProvinsi = oOpsBasisdata.fArrAmbilDataDbKondisi("", "", 
                        "tb_resto_pekerjaan", new String[]{"kode","nama"}, 
                        new String[]{"kode_resto_departemen",vKodeKaryawanRef}, "nomor", "ASC", new String[]{""}, "=");

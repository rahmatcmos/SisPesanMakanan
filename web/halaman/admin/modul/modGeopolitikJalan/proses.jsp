...
<%
    ...
    if(!vOperasi.equals("")){
        ...
        if(vOperasi.equals("t")){
            ...
            vKodeKecamatan = oKata.fSatuSpasi(request.getParameter("dtKodeKecamatan").toString()).substring(0,8);
            ...
            if(!vKode.equals("") && !vNama.equals("")){
                ...
                oOpsBasisdata.fOperasiBdDasar("",
                        ...
                        new String[]{"kode"}, 
                        new String[]{vKode},
                        new String[]{"null",vKode,vNama,vCatatan,vKodeNegara,vKodeProvinsi,vKodeKabupaten,vKodeKecamatan}, "t",true);
        ...
        if(vOperasi.equals("u")){
            ...
            if(!vKode.equals("") && !vNama.equals("")){
                oOpsBasisdata.fOperasiBdDasar("", 
                    ...
                    new String[]{"null",vKode,vNama,vCatatan,vKodeNegara,vKodeProvinsi,vKodeKabupaten,vKodeKecamatan}, 
                    "u",
                    true);

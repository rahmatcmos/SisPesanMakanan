...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","catatan","kode_geo_negara","kode_geo_provinsi","kode_geo_kabupaten","kode_geo_kecamatan"}, 
        ...
        while(vArrHasil.next()){
            ...
            vKodeKecamatan = vArrHasil.getString("kode_geo_kecamatan");
        }
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        String vSelKecamatan = "";
        
        /* A) operasi tambah data */
        if(vGetOperasi.equals("t")){
            /* 1) negara */
            vSelNegara = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_geo_negara", "");
            /* 2) provinsi */
            vSelProvinsi = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_geo_provinsi", "");
            /* 3) kabupaten */
            vSelKabupaten = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_geo_kabupaten", "");
            /* 4) kecamatan */
            vSelKecamatan = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_geo_kecamatan", "");
        }
        ...
        if(vGetOperasi.equals("u")){
            ...
            /* 3) kabupaten */
            vSelKecamatan = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_geo_kecamatan", vKodeKecamatan);
        }
        /* -------------------------------- */
        
        /* {FORM} */
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Negara","Provinsi","Kabupaten","Kecamatan","Catatan"}, 
            new String[]{"!Kode", "Nama","KodeNegara","KodeProvinsi","KodeKabupaten","KodeKecamatan","Catatan"}, 
            new String[]{"@t","@t","s","s","s","s","a"}, 
            new String[]{vKode,vNama,vSelNegara,vSelProvinsi,vSelKabupaten,vSelKecamatan,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modGeopolitikJalan" prefix="admin" %>
<admin:modal>
            ...
            //<![CDATA[
                $(document).ready(function() {
                    ...
                    $('#idTombolSimpan').click(function(e){
                        ...
                        var vKodeKecamatan = $('#idKodeKecamatan').val();
                        ...
                        if(vKode != "" && vNama != ""){
                            ...
                            var vReqSimpanData = $.ajax({
                                ...
                                data: { dtOperasi: vOperasi, 
                                    ...
                                    dtKodeKecamatan: vKodeKecamatan
                                },
                                dataType: "html"
                            });
                    ...
                    /* 3) Kabupaten */
                    $('#idKodeKabupaten').on('change', function() {
                        /* waktu */
                        vWaktu = vTgl.getTime();
                        var vKodeNegara = $('#idKodeNegara :selected').val();
                        var vKodeProvinsi = $('#idKodeProvinsi :selected').val();

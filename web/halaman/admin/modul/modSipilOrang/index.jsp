...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modSipilOrang" prefix="admin" %>
<admin:index>
        ...
        //<![CDATA[
            $(document).ready(function() {
                ...
                $(document).on('click', '.clsTombolUploadFoto', function(e){ 
                    ...
                    var vKode = $(this).attr("value");
                    /* redirect halaman */
                    window.location.replace("${URLModAdmin}/modSipilOrangGaleri/index.jsp?p=" + vKode);

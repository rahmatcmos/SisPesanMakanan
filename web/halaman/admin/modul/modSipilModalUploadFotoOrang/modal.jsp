...
<%
    ...
    //System.out.println("modSipilModalUploadFotoOrang -> modal.jsp -> vKodeOrang: " + vGetKodeOrang);
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modSipilModalUploadFotoOrang" prefix="admin" %>
<admin:modal>
                    ...
                    var options = {
                        ...
                        complete : function(response) {
                            ...
                            var vReqAmbilNamaBerkasFoto = $.ajax({
                                url: "${URLModAdmin}/modSipilOrangGaleri/proses.jsp?w=" + vWaktu,
                                type: "POST",
                                data: { 
                                    dtOperasi: "b", 
                    ...
                    function fPerbaharuiTabel(
                       ...
                       //console.log('#Perbaharui tabel : vFBerikut -> ' + vFBerikut + ', ' + 'vOffset -> ' + vOffset);
                        ...
                        var vReqDataTabel = $.ajax({
                            url: '${URLModAdmin}/modSipilOrangGaleri/tabel.jsp?o=' + vOffset + '&j='+ vFJumData + '&w=' + vWaktu,
                            type: 'POST',
                            data: {
                                dtKodeOrang: vKodeOrang,
                                dtKodeFotoOrang: vKodeFotoOrang,

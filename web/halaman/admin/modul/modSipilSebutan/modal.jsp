...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","singkatan","jenis_kelamin","catatan"}, 
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Singkatan","Jenis Kelamin","Catatan"}, 
            new String[]{"!Kode", "Nama","Singkatan","JenisKelamin","Catatan"}, 
            new String[]{"@t","@t","@t","r","a"}, 
            new String[]{vKode,vNama,vSingkatan,vJenisKelamin,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modSipilSebutan" prefix="admin" %>
<admin:modal>

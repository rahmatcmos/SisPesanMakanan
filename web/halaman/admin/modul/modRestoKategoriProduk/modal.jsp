...
<%
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Catatan"}, 
            new String[]{"!Kode", "Nama","Catatan"}, 
            new String[]{"@t","@t","a"}, 
            new String[]{vKode,vNama,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modRestoKategoriProduk" prefix="admin" %>
<admin:modal>

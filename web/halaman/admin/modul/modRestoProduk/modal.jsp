...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        while(vArrHasil.next()){
            ...
            vKodeKategoriProduk = vArrHasil.getString("kode_resto_kategori_produk");
            vKodeJenisProduk = vArrHasil.getString("kode_resto_jenis_produk");
            vKodeProdukSatuan = vArrHasil.getString("kode_produk_satuan");
            vHarga = vArrHasil.getString("harga");
        }
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        /* {DATA TAMBAHAN} */
        /* -------------------------------- */
        String vSelKategoriProduk = "";
        String vSelJenisProduk = "";
        String vSelProdukSatuan = "";
        
        /* A) operasi tambah data */
        if(vGetOperasi.equals("t")){
            /* 1) kategori produk */
            vSelKategoriProduk = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_kategori_produk", "");
            /* 2) jenis produk */
            vSelJenisProduk = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_jenis_produk", "");
            /* 3) satuan produk */
            vSelProdukSatuan = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_produk_satuan", "");
        }
        
        /* B) operasi ubah data */
        if(vGetOperasi.equals("u")){
            /* 1) kategori produk */
            vSelKategoriProduk = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_kategori_produk", vKodeKategoriProduk);
            /* 2) jenis produk */
            vSelJenisProduk = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_jenis_produk", vKodeJenisProduk);
            /* 3) satuan produk */
            vSelProdukSatuan = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_produk_satuan", vKodeProdukSatuan);
        }
        /* -------------------------------- */
        
        /* {FORM} */
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Kategori Produk","Jenis Produk","Satuan","Harga (Rp)","Catatan"}, 
            new String[]{"!Kode", "Nama","KodeKategoriProduk","KodeJenisProduk","KodeProdukSatuan","Harga","Catatan"}, 
            new String[]{"@t","@t","s","s","s","@t","a"}, 
            new String[]{vKode,vNama,vSelKategoriProduk,vSelJenisProduk,vSelProdukSatuan,vHarga,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modRestoProduk" prefix="admin" %>
<admin:modal>
            ...
            //<![CDATA[
                $(document).ready(function() {
                    ...
                    $('#idTombolSimpan').click(function(e){
                        ...
                        var vKodeKategoriProduk = $('#idKodeKategoriProduk').val();
                        var vKodeJenisProduk = $('#idKodeJenisProduk').val();
                        var vKodeProdukSatuan = $('#idKodeProdukSatuan').val();
                        ...
                        if(vKode != "" && vNama != ""){
                            ...
                            var vReqSimpanData = $.ajax({
                                ...
                                data: { dtOperasi: vOperasi, 
                                    ...
                                    dtNama : vNama,
                                    dtCatatan: vCatatan,
                                    dtKodeKategoriProduk: vKodeKategoriProduk,
                                    dtKodeJenisProduk: vKodeJenisProduk,
                                    dtKodeProdukSatuan: vKodeProdukSatuan,
                                    dtHarga: vHarga
                                },
                                dataType: "html"
                            });
                    ...
                    /* select change */
                    $('#idKodeKategoriProduk').on('change', function() {
                        /* waktu */
                        vWaktu = vTgl.getTime();
                        var vKodeKategoriProduk = this.value;
                        ...
                        var vReqSimpanData = $.ajax({
                            ...
                            type: "POST",
                            data: { dtOperasi: "s", 
                                dtKodeData: "jenis_produk",
                                dtKodeRef: vKodeKategoriProduk
                            },
                            dataType: "html"
                        });
                        ...
                        vReqSimpanData.done(function(vFDataSvr){
                            ...
                            if(vFDataSvr.trim() != "" && parseInt(vArrDataSvr[0]) > parseInt(0)){
                                ...
                                $('#idKodeJenisProduk option').each(function() {
                                    $(this).remove();
                                });

                                /* untuk setiap data dalam oData */
                                $.each(oData,function(id,el){
                                    $('#idKodeJenisProduk').append(
                                        $('<option>', { 
                                            value: el.kode,
                    ...
                    /* ------------------------------------------- */
                    /* kolom harga */
                    $("#idHarga").keydown(function (e) {
                        // perbolehkan: backspace, delete, tab, escape, enter and .

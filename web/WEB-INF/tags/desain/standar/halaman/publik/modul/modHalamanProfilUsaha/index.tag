...
<%@tag description="desain index modHalamanProfilUsaha" pageEncoding="UTF-8"%>
<%@ attribute name="atas" fragment="true" %>
<%@ attribute name="isi" fragment="true" %>

<% String vNamaModul = "modHalamanProfilUsaha"; %>
<% String vNamaData = "Profil Usaha"; %>
...
<% request.setAttribute("URLModAdmin", ClsKonf.vKonfURL + "/halaman/publik/modul"); %>
...
<% request.setAttribute("URLModAdminStdGambarFavicon", ClsKonf.vKonfURL + "/pilar/desain/" + vTema + "/halaman/publik/modul/modStandar/gambar/favicon"); %>

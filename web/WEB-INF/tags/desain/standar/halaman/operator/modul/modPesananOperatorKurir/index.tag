...
<%@tag description="desain index modPesananOperatorKurir" pageEncoding="UTF-8"%>
<%@ attribute name="atas" fragment="true" %>
<%@ attribute name="isi" fragment="true" %>

<% String vNamaModul = "modPesananOperatorKurir"; %>
<% String vNamaData = "Pesanan Operator Kurir"; %>
...
<head>
    <meta charset="utf-8">
    <title>Pesanan Operator Kurir</title>

...
<%@tag description="desain index modRestoModalUploadFotoProduk" pageEncoding="UTF-8"%>
<%@ attribute name="atas" fragment="true" %>
<%@ attribute name="isi" fragment="true" %>

<% String vNamaModul = "modRestoModalUploadFotoProduk"; %>
<% String vNamaData = "Upload Foto Produk"; %>

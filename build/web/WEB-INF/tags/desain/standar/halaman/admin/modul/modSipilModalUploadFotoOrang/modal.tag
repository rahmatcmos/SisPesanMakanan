...
<%@tag description="desain modal modSipilModalUploadFotoOrang" pageEncoding="UTF-8"%>
<%@ attribute name="atas" fragment="true" %>
<%@ attribute name="isi" fragment="true" %>

<% String vNamaModul = "modSipilModalUploadFotoOrang"; %>
<% String vNamaData = "Upload Foto Orang"; %>

...
<%@tag description="desain modal modHalamanBannerModalUploadFotoBanner" pageEncoding="UTF-8"%>
<%@ attribute name="atas" fragment="true" %>
<%@ attribute name="isi" fragment="true" %>

<% String vNamaModul = "modHalamanBannerModalUploadFotoBanner"; %>
<% String vNamaData = "Upload Foto Banner"; %>

...
<%@tag description="desain modal modHalamanBeritaModalUploadFotoBerita" pageEncoding="UTF-8"%>
<%@ attribute name="atas" fragment="true" %>
<%@ attribute name="isi" fragment="true" %>

<% String vNamaModul = "modHalamanBeritaModalUploadFotoBerita"; %>
<% String vNamaData = "Upload Foto Berita"; %>

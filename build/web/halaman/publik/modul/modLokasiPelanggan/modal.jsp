...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/publik/modul/modLokasiPelanggan" prefix="publik" %>
<publik:modal>
	...
	<script type="text/javascript">
            ...
            //<![CDATA[
                $(document).ready(function() {
                    /* placeholder catatan */
                    $('#idCatatan').attr("placeholder","Lantai, nomor kamar, dsb,");
                    ...
                    function fBuatRute(vFLintangResto,vFBujurResto,vFLintangPelanggan,vFBujurPelanggan){
                        ...
                        vDirectionsService.route(request, function (response, status) {
                            if (status == google.maps.DirectionsStatus.OK) {
                                ...
                                $('#idAlamat').val(vArrLeg.end_address);
                            } else {

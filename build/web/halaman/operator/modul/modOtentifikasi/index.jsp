...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/operator/modul/modOtentifikasi" prefix="operator" %>
<operator:index>
                ...
                $("#idKirim").click(function(e) {
                    ...
                    if(vNama.trim() != '' && vSandi.trim() !='' && vKode.trim() != ''){				
                        ...
                        var vPermintaan = $.ajax({
                                url: "${URL}/clsOperatorOtentifikasi?w="+ vMiliDetik,
                                type: "POST",
                        ...
                        vPermintaan.done(function(vFDataServer) {					
                                ...
                                if(vFDataServer.trim() === '1'){
                                        ...
                                        var vURL = "${URLModOperator}/modMenuUtama/index.jsp";
  ...
  <jsp:attribute name="isi">
	...
	<div id="idFormMasuk">
            <div class="divTeksMasuk">Operator</div>
                <div id="divUbahTambah" class="">
                    <form id="idFmMasukOperator" name="nmFmMasukOperator" method="post" action="#" >

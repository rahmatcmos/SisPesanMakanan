...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/operator/modul/modPesananOperatorPemesanan" prefix="operator" %>
<operator:index>
        ...
        //<![CDATA[
            $(document).ready(function() {
                ...
                $('#idTabelData').delegate('tbody > tr > td', 'mouseover', function() {
                    ...
                    $('.clsTombolUploadFoto').eq(vIndeks).removeAttr('style');
                ...
                $('#idTabelData').delegate('tbody > tr > td', 'mouseleave', function() {
                    var vIndeks = $(this).parent().index();
                    $('.clsTombolUploadFoto').eq(vIndeks).attr('style','display:none');
                ...
                /* [T5] tombol upload foto */
                $(document).on('click', '.clsTombolUploadFoto', function(e){ 
                    //alert($(this).attr("value"));
                    /* cegah aksi bawaan */
                    e.preventDefault();
                    vWaktu = vTgl.getTime();
                        ...
                        <table id="idTabelJudulModul">
                            <tr>
                                <td class="clsTdGambar">
                                    <a href="${URLModOperator}/modMenuUtama/index.jsp">
                                        <button class="clsTombolMenuBalik grow">
                                            <img src="${URLModAdpubGambarTombol}/tombolBalik48.png"/>
                                        </button>
                                    </a>
                                </td>
                                <td class="clsTdJudulMod">Pesanan Operator Pemesanan</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table id="idTabelCari">
                            <tr>
                                <td><select id="idSelCari" class="clsSelCari">
                                        ...
                                        <option value="nama_pelanggan" selected>Nama Pelanggan</option>
                                    </select>
                                </td>
                    ...
                    <div id="idDivTabelData">
                        <table id="idTabelData">
                            <thead class="clsThTabel">
                                ...
                                <th class="clsThKode">Kode Faktur</th>
                                <th class="clsThNama" colspan="2">Nama ${vModKonfNamaData}</th>

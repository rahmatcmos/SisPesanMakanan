...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","catatan","kode_resto_departemen"}, 
        ...
        while(vArrHasil.next()){
            ...
            vKodeDepartemen = vArrHasil.getString("kode_resto_departemen");
        }
        /* gambar icon */
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Departemen","Catatan"}, 
            new String[]{"!Kode", "Nama","KodeDepartemen","Catatan"}, 
            new String[]{"@t","@t","s","a"}, 
            new String[]{vKode,vNama,vSelDepartemen,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modRestoPekerjaan" prefix="admin" %>
<admin:modal>

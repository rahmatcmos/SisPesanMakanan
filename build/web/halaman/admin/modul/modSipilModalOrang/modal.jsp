...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modSipilModalOrang" prefix="admin" %>
<admin:modal>
            ...
            //<![CDATA[
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.clsTombolPilihModal', function(e){ 
                        ...
                        $(window.parent.document).find("#idKodeOrang").val(vArrKodeNama[0]);

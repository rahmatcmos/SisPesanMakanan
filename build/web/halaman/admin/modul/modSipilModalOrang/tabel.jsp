...
<% 
    ...
    */
    ...
    if(vTeksCari.trim().equals("")){
        ...
        /* keluaran pencarian */
        vArrHasil = oOpsBasisdata.fArrAmbilDataDbStd("", "", vNamaTabel, new String[]{"kode","nama_lengkap"}, "nomor", vUrutanData, new String[]{vGetOffset,vGetJumData});
    }
    ...
    if(!vTeksCari.trim().equals("")){
        ...
        /* keluaran pencarian */
        vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", "", vNamaTabel, new String[]{"kode","nama_lengkap"}, new String[]{vKolomCari,vTeksCari},"nomor", vUrutanData, new String[]{vGetOffset,vGetJumData},"%LIKE%");
    }
    ...
    while(vArrHasil.next()){
        if(!vArrHasil.getString("kode").trim().equals("")){
            ...
            if(vBarisPertama){
                ...
                vSbJSON.append("\", "); 
                vSbJSON.append("\"nama\":\"");
                vSbJSON.append(vArrHasil.getString("nama_lengkap"));
                vSbJSON.append("\""); 
                vSbJSON.append("}");
                vBarisPertama = false;
            }else{

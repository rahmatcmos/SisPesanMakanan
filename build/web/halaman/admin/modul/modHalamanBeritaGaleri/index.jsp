...
<% 
    ...
    String vGetKodeBerita = oOlahKata.fHapusSpasi(request.getParameter("b"));
    request.setAttribute("vGetKodeBerita", vGetKodeBerita);
    
    /* ambil judul berita */
    ClsOperasiBasisdata oOpsBasisdata = new ClsOperasiBasisdata();
    
    String vJudulBerita = oOpsBasisdata.fAmbilSatuData("", "", 
            "tb_hlm_berita", "judul", "kode", vGetKodeBerita);
    request.setAttribute("vJudulBerita", vJudulBerita);
%>

<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modHalamanBeritaGaleri" prefix="admin" %>
<admin:index>
            ...
            $(document).ready(function() {
                ...
                $('#idTambah48').click(function(e) {
                    ...
                    Custombox.open({
                        ...
                        target: '${URLModAdmin}/modHalamanBeritaModalUploadFotoBerita/modal.jsp?o=t&b=${vGetKodeBerita}&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        overlayClose: false
                    });
                ...
                $(document).on('click', '.clsTombolUbah', function(e){ 
                   //alert($(this).attr("value"));
                    ...
                    var vKodeBerita = '${vGetKodeBerita}';
                    var vKodeFotoBerita = $(this).attr("value");
                                        
                    /* menampilkan halaman dalam bentuk modal */
                    Custombox.open({
                        target: '${URLMod}/modal.jsp?o=u&b=' + vKodeBerita + '&k=' + vKodeFotoBerita + '&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        width: 380,
                        cache: false,
                ...
                $(document).on('click', '.clsTombolHapus', function(e){ 
                   //alert($(this).attr("value"));
                    ...
                    var vKodeFotoBerita = $(this).attr("value");
                    Custombox.open({
                        target: '${URLMod}/modal.jsp?o=h&b=' + vKodeBerita + '&k=' + vKodeFotoBerita + '&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        width: 380,
                        cache: false,
                ...
                $("#idHapus32").click(function(e){
                    ...
                    if(vSemuaKode != ""){
                        ...
                        /* menampilkan modal */
                        Custombox.open({
                            target: '${URLMod}/modal.jsp?o=h&b=' + vKodeBerita + '&k=' + encodeURIComponent(vSemuaKode) + '&w=' + vWaktu,
                            effect: 'slide',
                            animation: 'top,top',
                            width: 380,
                            cache: false,
                            ...
                            $.each(oData,function(id,el){
                                ...
                                var vFoto = '<div id=\"idDivKotakFoto\" class=\"clsDivKotakFoto wobble-vertical\">' + 
                                                '<div id=\"idDivBerkasFoto\" class=\"clsDivBerkasFoto\" >' +
                                                    '<img id=\"idBerkasFoto\" class=\"clsBerkasFoto\" src=\"' + '${URLModAdpubFoto}' + '/berita/t' + el.berkas + el.ekstensi + '\" alt=\"' + i + '\" />' +
               ...
               /* fStatusAdaDlmArray: status apakah suatu nilai sudah ada dalam array.
                ...
                function fStatusAdaDlmArray(vFAnggotaBaru, vFArray){
                    ...
                    for(i=0;i<vArrFaktor.length;i++){
                        if(vBoolPertama){
                            vBerita = vArrFaktor[i];
                            vBoolPertama = false;
                        }else{
                            vBerita = vArrFaktor[i] * vBerita;
                        }
                        //console.log("vBerita: " + vBerita);
                    }
                    
                    return (vBerita==0)?true:false;
                }
                        ...
                        <table id="idTabelJudulModul">
                            <tr>
                                <td class="clsTdGambar">
                                    <a href="${URLModAdmin}/modHalamanBerita/index.jsp">
                                        <button class="clsTombolMenuBalik grow">
                                            <img src="${URLModAdpubGambarTombol}/tombolBalik48.png"/>
                                        </button>
                                    </a>
                                </td>
                                <td class="clsTdJudulMod">Administrasi Data ${vModKonfNamaData} <br>Berita: ${vGetKodeBerita} - ${vJudulBerita}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <div id="idDivTabelData">
                        <table id="idTabelData">
                            <thead class="clsThTabel">
                                ...
                                <th class="clsThNama">${vModKonfNamaData}</th>

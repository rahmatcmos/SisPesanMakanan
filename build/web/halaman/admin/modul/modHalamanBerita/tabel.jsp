...
<% 
    ...
    */
    ...
    if(vTeksCari.trim().equals("")){
        ...
        /* keluaran pencarian */
        vArrHasil = oOpsBasisdata.fArrAmbilDataDbStd("", "", vNamaTabel, new String[]{"kode","judul"}, "nomor", vUrutanData, new String[]{vGetOffset,vGetJumData});
    }
    ...
    if(!vTeksCari.trim().equals("")){
        ...
        /* keluaran pencarian */
        vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", "", vNamaTabel, new String[]{"kode","judul"}, new String[]{vKolomCari,vTeksCari},"nomor", vUrutanData, new String[]{vGetOffset,vGetJumData},"%LIKE%");
    }

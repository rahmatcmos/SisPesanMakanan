...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","catatan","kode_geo_negara","kode_geo_provinsi","kode_geo_kabupaten"}, 
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Negara","Provinsi","Kabupaten","Catatan"}, 
            new String[]{"!Kode", "Nama","KodeNegara","KodeProvinsi","KodeKabupaten","Catatan"}, 
            new String[]{"@t","@t","s","s","s","a"}, 
            new String[]{vKode,vNama,vSelNegara,vSelProvinsi,vSelKabupaten,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modGeopolitikKecamatan" prefix="admin" %>
<admin:modal>
  ...
  <jsp:attribute name="isi">
    <div class="clsModalIsi">
        <div class="clsModalJudul">
            ...
            <h4><img src="${URLModAdpubGambarData}/${vHTMLGambarIcon}"/> &nbsp; <strong>${vHTMLOperasi} Data ${vHTMLModKonfNamaData}</strong></h4>
        </div>

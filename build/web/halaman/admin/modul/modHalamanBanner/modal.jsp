...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","judul","teks","kode_foto","publikasi"}, 
        ...
        while(vArrHasil.next()){
            ...
            vJudul = vArrHasil.getString("judul");
    ...
    if(vGetOperasi.equals("h")){
        ...
        if(vArrKodeHapus.length == 0){
            /* ambil data */
            ClsOperasiBasisdata oOpsBasisdata = new ClsOperasiBasisdata();
            ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", "", vModKonfNamaTabel, new String[]{"kode","judul"}, new String[]{"kode",vGetKodeHapus}, "nomor", "DESC", new String[]{"0","1"},"=");
        ...
        if(vArrKodeHapus.length > 0){
            ...
            for(String vKodeHapus : vArrKodeHapus){
                /* ambil data */
                ClsOperasiBasisdata oOpsBasisdata = new ClsOperasiBasisdata();
                ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", "", vModKonfNamaTabel, new String[]{"kode","judul"}, new String[]{"kode",vKodeHapus}, "nomor", "DESC", new String[]{"0","1"},"=");
                ...
                if(vPertama){
                    oSbKode.append("[ ").append(vKode).append(" ] ").append(" ").append(vJudul);
                    vPertama = false;
                }else{
                    oSbKode.append(", [ ").append(vKode).append(" ] ").append(" ").append(vJudul);
                }
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        System.out.println(vJudul.replace("\"", "&quot;"));
        
        /* form */
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Judul " + vModKonfNamaData,"Foto","Publikasi","Teks"}, 
            new String[]{"!Kode", "Judul","KodeFoto","Publikasi","Teks"}, 
            new String[]{"@t","@t","@t","r","a"}, 
            new String[]{vKode,vJudul,vKodeFoto,vPublikasi,vTeks}, 
            oForm.fTombol("bt", "idTombolSimpan","Simpan","tombolAjaxSimpan.png"),
            "idFormBanner", 
            "clsFormTE");
        
        /* class modal */
        vClsModalIsi = "clsModalIsi700TE";
        vClsModalJudul = "clsModalJudul700TE";
        vClsModalBody = "clsModalBody700TE";
        vIdPesanModal = "idPesanModal700TE";
     }
    ...
    if(vGetOperasi.equals("h")){
        ...
        /* class modal */
        vClsModalIsi = "clsModalIsi";
        vClsModalJudul = "clsModalJudul";
        vClsModalBody = "clsModalBody";
        vIdPesanModal = "idPesanModal";
    }
    ...
    /* class modal */
    request.setAttribute("vClsModalIsi", vClsModalIsi);
    request.setAttribute("vClsModalJudul", vClsModalJudul);
    request.setAttribute("vClsModalBody", vClsModalBody);
    request.setAttribute("vIdPesanModal", vIdPesanModal);
%>

<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modHalamanBanner" prefix="admin" %>
<admin:modal>
  ...
  <jsp:attribute name="isi">
    <div class="${vClsModalIsi}">
        <div class="${vClsModalJudul}">
        ...
        <div class="${vClsModalBody}">
            <center>
            <div id="${vIdPesanModal}" class="clsSembuyikanPesan"></div>
            ${vHTMLForm}
            </center>
        </div>
    </div>

        ...
        //<![CDATA[
            $(document).ready(function() {
                ...
                $(document).on('click', '.clsTombolUploadFoto', function(e){ 
                    ...
                    var vKode = $(this).attr("value");
                    /* redirect halaman */
                    window.location.replace("${URLModAdmin}/modHalamanBannerGaleri/index.jsp?b=" + vKode);
                    ...
                    <div id="idDivTabelData">
                        <table id="idTabelData">
                            <thead class="clsThTabel">
                                ...
                                <th class="clsThNama" colspan="2">Judul ${vModKonfNamaData}</th>

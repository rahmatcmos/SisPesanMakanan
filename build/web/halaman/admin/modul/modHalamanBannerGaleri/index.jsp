...
<% 
    ...
    String vJudulBanner = oOpsBasisdata.fAmbilSatuData("", "", 
            "tb_hlm_banner", "judul", "kode", vGetKodeBanner);
    request.setAttribute("vJudulBanner", vJudulBanner);
%>

<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modHalamanBannerGaleri" prefix="admin" %>
<admin:index>
            ...
            $(document).ready(function() {
                ...
                $('#idTambah48').click(function(e) {
                    ...
                    Custombox.open({
                        ...
                        target: '${URLModAdmin}/modHalamanBannerModalUploadFotoBanner/modal.jsp?o=t&b=${vGetKodeBanner}&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        overlayClose: false
                    });
                ...
                $(document).on('click', '.clsTombolUbah', function(e){ 
                   //alert($(this).attr("value"));
                    ...
                    var vKodeFotoBanner = $(this).attr("value");
                                        
                    /* menampilkan halaman dalam bentuk modal */
                    Custombox.open({
                        target: '${URLMod}/modal.jsp?o=u&b=' + vKodeBanner + '&k=' + vKodeFotoBanner + '&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        width: 380,
                        cache: false,
                ...
                $(document).on('click', '.clsTombolHapus', function(e){ 
                   //alert($(this).attr("value"));
                    ...
                    var vKodeFotoBanner = $(this).attr("value");
                    Custombox.open({
                        target: '${URLMod}/modal.jsp?o=h&b=' + vKodeBanner + '&k=' + vKodeFotoBanner + '&w=' + vWaktu,
                        effect: 'slide',
                        animation: 'top,top',
                        width: 380,
                        cache: false,
                ...
                $("#idHapus32").click(function(e){
                    ...
                    if(vSemuaKode != ""){
                        ...
                        /* menampilkan modal */
                        Custombox.open({
                            target: '${URLMod}/modal.jsp?o=h&b=' + vKodeBanner + '&k=' + encodeURIComponent(vSemuaKode) + '&w=' + vWaktu,
                            effect: 'slide',
                            animation: 'top,top',
                            width: 380,
                            cache: false,
                            ...
                            $.each(oData,function(id,el){
                                ...
                                var vFoto = '<div id=\"idDivKotakFoto\" class=\"clsDivKotakFoto wobble-vertical\">' + 
                                                '<div id=\"idDivBerkasFoto\" class=\"clsDivBerkasFoto\" >' +
                                                    '<img id=\"idBerkasFoto\" class=\"clsBerkasFoto\" src=\"' + '${URLModAdpubFoto}' + '/banner/t' + el.berkas + el.ekstensi + '\" alt=\"' + i + '\" />' +
               ...
               /* fStatusAdaDlmArray: status apakah suatu nilai sudah ada dalam array.
                ...
                function fStatusAdaDlmArray(vFAnggotaBaru, vFArray){
                    ...
                    for(i=0;i<vArrFaktor.length;i++){
                        if(vBoolPertama){
                            vBanner = vArrFaktor[i];
                            vBoolPertama = false;
                        }else{
                            vBanner = vArrFaktor[i] * vBanner;
                        }
                        //console.log("vBanner: " + vBanner);
                    }
                    
                    return (vBanner==0)?true:false;
                }
                        ...
                        <table id="idTabelJudulModul">
                            <tr>
                                <td class="clsTdGambar">
                                    <a href="${URLModAdmin}/modHalamanBanner/index.jsp">
                                        <button class="clsTombolMenuBalik grow">
                                            <img src="${URLModAdpubGambarTombol}/tombolBalik48.png"/>
                                        </button>
                                    </a>
                                </td>
                                <td class="clsTdJudulMod">Administrasi Data ${vModKonfNamaData} <br>Banner: ${vGetKodeBanner} - ${vJudulBanner}</td>
                            </tr>
                        </table>
                    </td>
                </tr>

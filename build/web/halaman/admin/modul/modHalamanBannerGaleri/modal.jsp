...
<%
    ...
    vGetKodeBanner = oKata.fHapusSpasi(request.getParameter("b"));
    ...
    if(vGetOperasi.equals("u")){
        vHTMLOperasi = "Ubah";
        vGetKodeFotoBanner = oKata.fHapusSpasi(request.getParameter("k"));
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisiArr("", 
                ...
                new String[]{"kode","kode_hlm_banner"},
                new String[]{vGetKodeFotoBanner,vGetKodeBanner},
    ...
    if(vGetOperasi.equals("h")){
        ...
        vHTMLForm = oForm.fFormYaTidak("POST","#",vKalimat, 
                ...
                "idForm", 
                "clsForm",
                new String[]{"idKodeFotoBanner",vGetKodeHapus});
    }
	...
	<script type="text/javascript">
            ...
            //<![CDATA[
                $(document).ready(function() {
                    /* {VARIABEL GLOBAL} */
                    var vTgl = new Date();
                    var vWaktu, vOperasi, vKodeBanner, vKodeFotoBanner; /* data yang dikirim */
                    ...
                    $('#idTombolYa').click(function(e){
                        ...
                        vKodeBanner = '${vGetKodeBanner}';
                        vKodeFotoBanner = $('#idKodeFotoBanner').val();

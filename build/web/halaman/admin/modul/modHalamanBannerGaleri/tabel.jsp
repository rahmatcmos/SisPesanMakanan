...
<% 
    ...
    String vPostKodeBanner = oKata.fHapusSpasi(request.getParameter("dtKodeBanner"));
    ...
    */
    ...
    if(vTeksCari.trim().equals("")){
        ...
        vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                ...
                new String[]{"kode_hlm_banner",vPostKodeBanner},
                "nomor", 
                vUrutanData, 
    ...
    if(!vTeksCari.trim().equals("")){
        ...
        vJumDataTotal = oOpsBasisdata.fJumDataTotalKondisiArr("", 
                ...
                vNamaTabel, 
                new String[]{"kode"}, 
                new String[]{vKolomCari,"kode_hlm_banner"}, 
                new String[]{vTeksCari,vPostKodeBanner}, 
                new String[]{"%LIKE%","="},
                new String[]{"AND"}
                );
        /* keluaran pencarian */

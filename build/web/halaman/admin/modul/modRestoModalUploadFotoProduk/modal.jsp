...
<%
    ...
    //System.out.println("modRestoModalUploadFotoProduk -> modal.jsp -> vKodeProduk: " + vGetKodeOrang);
    
    /* kode foto produk */
    ClsKode oKode = new ClsKode();
    String vKodeFotoOrang = vModKonfKodeAwal + oKode.fBuatKodeAcak(14).toUpperCase();
    ...
    request.setAttribute("vKodeFotoOrang", vKodeFotoOrang);
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modRestoModalUploadFotoProduk" prefix="admin" %>
<admin:modal>
                ...
                $(document).ready(function() {
                    ...
                    var options = {
                        ...
                        complete : function(response) {
                            ...
                            var vOperasi = 't';
                            var vKodeProduk = '${vGetKodeOrang}';
                            var vKodeFotoOrang = '${vKodeFotoOrang}';
                            
                            /* operasi ajax */
                            var vReqAmbilNamaBerkasFoto = $.ajax({
                                url: "${URLModAdmin}/modRestoProdukGaleri/proses.jsp?w=" + vWaktu,
                                type: "POST",
                                data: { 
                                    dtOperasi: "b", 
                                    dtKodeProduk: vKodeProduk,
                                    dtKodeFotoProduk : vKodeFotoOrang
                                },
                                dataType: "text"
                            });
                    ...
                    function fPerbaharuiTabel(
                       ...
                       //console.log('#Perbaharui tabel : vFBerikut -> ' + vFBerikut + ', ' + 'vOffset -> ' + vOffset);
                        ...
                        /* nilai kriteria dan teks pencarian */
                        var vKodeProduk = '${vGetKodeOrang}';
                        var vKodeFotoOrang = '${vGetKodeOrang}';
                        var vKolomCari = $(window.parent.document).find('#idSelCari').val();
                        var vTeksCari = $(window.parent.document).find('#idTeksCari').val();
                        
                        //console.log("vReqDataTabel.start");
                        var vReqDataTabel = $.ajax({
                            url: '${URLModAdmin}/modRestoProdukGaleri/tabel.jsp?o=' + vOffset + '&j='+ vFJumData + '&w=' + vWaktu,
                            type: 'POST',
                            data: {
                                dtKodeProduk: vKodeProduk,
                                dtKodeFotoProduk: vKodeFotoOrang,
            ...
            <form id="idUploadForm" action="${URL}/ClsSrvUploadFoto" method="post" enctype="multipart/form-data">
                <table id="idTabelUploadFoto">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><input type="text" id="idKode" name="nmKode" value="${vKodeFotoOrang}" readonly/></td>
                    </tr>
                    <tr>
                ...
                <input type="hidden" id="idKode" name="nmKodeRef" value="${vGetKodeOrang}"/>

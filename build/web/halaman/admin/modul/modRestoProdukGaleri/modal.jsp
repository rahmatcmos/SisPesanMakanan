...
<%
    ...
    vGetKodeProduk = oKata.fHapusSpasi(request.getParameter("p"));
    ...
    if(vGetOperasi.equals("u")){
        vHTMLOperasi = "Ubah";
        vGetKodeFotoProduk = oKata.fHapusSpasi(request.getParameter("k"));
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisiArr("", 
                ...
                new String[]{"kode","kode_resto_produk"},
                new String[]{vGetKodeFotoProduk,vGetKodeProduk},
    ...
    if(vGetOperasi.equals("h")){
        ...
        vHTMLForm = oForm.fFormYaTidak("POST","#",vKalimat, 
                ...
                "idFormNegara", 
                "clsForm",
                new String[]{"idKodeFotoProduk",vGetKodeHapus});
    }
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modRestoProdukGaleri" prefix="admin" %>
<admin:modal>
	...
	<script type="text/javascript">
            ...
            //<![CDATA[
                $(document).ready(function() {
                    /* {VARIABEL GLOBAL} */
                    var vTgl = new Date();
                    var vWaktu, vOperasi, vKodeProduk, vKodeFotoProduk; /* data yang dikirim */
                    ...
                    $('#idTombolYa').click(function(e){
                        ...
                        vKodeProduk = '${vGetKodeProduk}';
                        vKodeFotoProduk = $('#idKodeFotoProduk').val();
                        ...
                        var vReqHapusData = $.ajax({
                            ...
                            data: { 
                                ...
                                dtKodeFotoProduk : vKodeFotoProduk
                            },
                            dataType: "text"
                        });

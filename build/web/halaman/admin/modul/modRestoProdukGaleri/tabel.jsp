...
<% 
    ...
    String vPostKodeProduk = oKata.fHapusSpasi(request.getParameter("dtKodeProduk"));
    ...
    */
    ...
    if(vTeksCari.trim().equals("")){
        ...
        vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                ...
                new String[]{"kode_resto_produk",vPostKodeProduk},
                "nomor", 
                vUrutanData, 
    ...
    if(!vTeksCari.trim().equals("")){
        ...
        vJumDataTotal = oOpsBasisdata.fJumDataTotalKondisiArr("", 
                ...
                vNamaTabel, 
                new String[]{"kode"}, 
                new String[]{vKolomCari,"kode_resto_produk"}, 
                new String[]{vTeksCari,vPostKodeProduk}, 
                new String[]{"%LIKE%","="},
                new String[]{"AND"}
                );
        /* keluaran pencarian */

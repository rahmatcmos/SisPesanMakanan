...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","singkatan","letak","catatan"}, 
        ...
        while(vArrHasil.next()){
            ...
            vSingkatan = vArrHasil.getString("singkatan");
            vLetak = vArrHasil.getString("letak");
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        if(vGetOperasi.equals("u")){
            ...
            if(vLetak.equals("1")){
                vSbJK.append("@");
                vSbJK.append(vLetak);
                vSbJK.append("&Depan#0&Belakang");
            }else{
                vSbJK.append("1&Depan#");
                vSbJK.append("@");
                vSbJK.append(vLetak);
                vSbJK.append("&Belakang");
            }
            vLetak = vSbJK.toString();
        }
        
        
        
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Singkatan","Letak","Catatan"}, 
            new String[]{"!Kode", "Nama","Singkatan","Letak","Catatan"}, 
            new String[]{"@t","@t","@t","r","a"}, 
            new String[]{vKode,vNama,vSingkatan,vLetak,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modSipilGelar" prefix="admin" %>
<admin:modal>
            ...
            //<![CDATA[
                $(document).ready(function() {
                    ...
                    $('#idTombolSimpan').click(function(e){
                        ...
                        var vSingkatan = $('#idSingkatan').val();
                        var vLetak = $("input[name=nmLetak]:checked").val();

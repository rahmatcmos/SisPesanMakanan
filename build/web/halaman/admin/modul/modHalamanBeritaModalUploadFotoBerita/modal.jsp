...
<%
    ...
    //System.out.println("modHalamanBeritaModalUploadFotoBerita -> modal.jsp -> vKodeBerita: " + vGetKodeBerita);
    
    /* kode foto produk */
    ClsKode oKode = new ClsKode();
    String vKodeFotoBerita = vModKonfKodeAwal + oKode.fBuatKodeAcak(14).toUpperCase();
    ...
    request.setAttribute("vKodeFotoBerita", vKodeFotoBerita);
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modHalamanBeritaModalUploadFotoBerita" prefix="admin" %>
<admin:modal>
                ...
                $(document).ready(function() {
                    ...
                    var options = {
                        ...
                        complete : function(response) {
                            ...
                            var vKodeFotoBerita = '${vKodeFotoBerita}';
                            
                            /* operasi ajax */
                            var vReqAmbilNamaBerkasFoto = $.ajax({
                                url: "${URLModAdmin}/modHalamanBeritaGaleri/proses.jsp?w=" + vWaktu,
                                type: "POST",
                                data: { 
                                    dtOperasi: "b", 
                                    dtKodeBerita: vKodeBerita,
                                    dtKodeFotoBerita : vKodeFotoBerita
                                },
                                dataType: "text"
                            });
                    ...
                    function fPerbaharuiTabel(
                       ...
                       //console.log('#Perbaharui tabel : vFBerikut -> ' + vFBerikut + ', ' + 'vOffset -> ' + vOffset);
                        ...
                        /* nilai kriteria dan teks pencarian */
                        var vKodeBerita = '${vGetKodeBerita}';
                        var vKodeFotoBerita = '${vGetKodeBerita}';
                        var vKolomCari = $(window.parent.document).find('#idSelCari').val();
                        var vTeksCari = $(window.parent.document).find('#idTeksCari').val();
                        
                        //console.log("vReqDataTabel.start");
                        var vReqDataTabel = $.ajax({
                            url: '${URLModAdmin}/modHalamanBeritaGaleri/tabel.jsp?o=' + vOffset + '&j='+ vFJumData + '&w=' + vWaktu,
                            type: 'POST',
                            data: {
                                dtKodeBerita: vKodeBerita,
                                dtKodeFotoBerita: vKodeFotoBerita,
            ...
            <form id="idUploadForm" action="${URL}/ClsSrvUploadFoto" method="post" enctype="multipart/form-data">
                <table id="idTabelUploadFoto">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><input type="text" id="idKode" name="nmKode" value="${vKodeFotoBerita}" readonly/></td>
                    </tr>
                    <tr>
                ...
                <input type="hidden" id="idKode" name="nmKodeRef" value="${vGetKodeBerita}"/>

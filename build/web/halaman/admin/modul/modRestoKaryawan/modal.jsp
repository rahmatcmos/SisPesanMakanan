...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","catatan","kode_resto_pekerjaan","kode_sipil_orang","tanggal_masuk","tanggal_berhenti","aktif"}, 
        ...
        while(vArrHasil.next()){
            ...
            vKodePekerjaan = vArrHasil.getString("kode_resto_pekerjaan");
            vKodeOrang = vArrHasil.getString("kode_sipil_orang");
            vTanggalMasuk = vArrHasil.getString("tanggal_masuk");
            vTanggalBerhenti = vArrHasil.getString("tanggal_berhenti");
            vAktif = vArrHasil.getString("aktif");
        }
        
        vKodeDepartemen = oOpsBasisdata.fAmbilSatuData("", "", "tb_resto_pekerjaan", "kode_resto_departemen", "kode", vKodePekerjaan);
        /* gambar icon */
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        /* {DATA TAMBAHAN} */
        /* -------------------------------- */
        String vSelDepartemen = "";
        String vSelPekerjaan = "";
        
        /* A) operasi tambah data */
        if(vGetOperasi.equals("t")){
            /* 1) departemen */
            vSelDepartemen = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_departemen", "");
            /* 2) pekerjaan */
            vSelPekerjaan = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_pekerjaan", "");
            /* 3) aktif */
            vAktif = "@1&Ya#0&Tidak";
        }
        ...
        if(vGetOperasi.equals("u")){
            /* 1) departemen */
            vSelDepartemen = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_departemen", vKodeDepartemen);
            /* 2) pekerjaan */
            vSelPekerjaan = oOpsBasisdata.fAmbilDataSelectHTML("", "", "tb_resto_pekerjaan", vKodePekerjaan);
            /* 3) aktif */
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Kode Orang","Nama " + vModKonfNamaData,"Departemen","Pekerjaan","Aktif","Tanggal Masuk","Tanggal Berhenti","Catatan"}, 
            new String[]{"!Kode", ">KodeOrang",">Nama","KodeDepartemen","KodePekerjaan","Aktif","TanggalMasuk","TanggalBerhenti","Catatan"}, 
            new String[]{"@t","@t","@t","s","s","r","@t","@t","a"}, 
            new String[]{vKode,vKodeOrang,vNama,vSelDepartemen,vSelPekerjaan,vAktif,vTanggalMasuk,vTanggalBerhenti,vCatatan}, 
    ...
    /* tahun masuk & berhenti min dan maks */
    Date vTanggalSekarang =  new Date(System.currentTimeMillis());
    String vTahunMasukMaks = "",
        vTahunMasukMin = "",
        vTahunBerhentiMaks = "",
        vTahunBerhentiMin = "";
    ...
    Calendar vKalenderMasukMaks = Calendar.getInstance();
    vKalenderMasukMaks.setTime(vTanggalSekarang);
    vKalenderMasukMaks.add(Calendar.YEAR, 1);
    vTahunMasukMaks = simpleDateformat.format(vKalenderMasukMaks.getTime());
    
    Calendar vKalenderMasukMin = Calendar.getInstance();
    vKalenderMasukMin.setTime(vTanggalSekarang);
    vKalenderMasukMin.add(Calendar.YEAR, -70);
    vTahunMasukMin = simpleDateformat.format(vKalenderMasukMin.getTime());
    
    Calendar vKalenderBerhentiMaks = Calendar.getInstance();
    vKalenderBerhentiMaks.setTime(vTanggalSekarang);
    vKalenderBerhentiMaks.add(Calendar.YEAR, 10);
    vTahunBerhentiMaks = simpleDateformat.format(vKalenderBerhentiMaks.getTime());
    
    Calendar vKalenderBerhentiMin = Calendar.getInstance();
    vKalenderBerhentiMin.setTime(vTanggalSekarang);
    vKalenderBerhentiMin.add(Calendar.YEAR, -70);
    vTahunBerhentiMin = simpleDateformat.format(vKalenderBerhentiMin.getTime());
    ...
    request.setAttribute("vTahunMasukMin", vTahunMasukMin);
    request.setAttribute("vTahunMasukMaks", vTahunMasukMaks);
    request.setAttribute("vTahunBerhentiMin", vTahunBerhentiMin);
    request.setAttribute("vTahunBerhentiMaks", vTahunBerhentiMaks);
%>

<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modRestoKaryawan" prefix="admin" %>
<admin:modal>
	...
	<script type="text/javascript">
            ...
            //<![CDATA[
                $(document).ready(function() {
                    ...
                    /* tanggal masuk */
                    $('#idTanggalMasuk').datetimepicker({
                        timepicker:false,
                        format:'Y-m-d',
                        mask:true,
                        validateOnBlur:true,
                        closeOnDateSelect:true,
                        minDate:'${vTahunMasukMin}/01/01',
                        maxDate:'${vTahunMasukMaks}/01/01'
                    });
                    
                    /* tanggal berhenti */
                    $('#idTanggalBerhenti').datetimepicker({
                        timepicker:false,
                        format:'Y-m-d',
                        mask:true,
                        validateOnBlur:true,
                        closeOnDateSelect:true,
                        minDate:'${vTahunBerhentiMin}/01/01',
                        maxDate:'${vTahunBerhentiMaks}/01/01'
                    });
                    ...
                    $('#idTombolSimpan').click(function(e){
                        ...
                        var vKodeOrang = $('#idKodeOrang').val();
                        var vNama = $('#idNama').val();
                        var vCatatan = $('#idCatatan').val();
                        var vKodeDepartemen = $('#idKodeDepartemen').val();
                        var vKodePekerjaan = $('#idKodePekerjaan').val();
                        var vTanggalMasuk = $('#idTanggalMasuk').val();
                        var vTanggalBerhenti = $('#idTanggalBerhenti').val();
                        ...
                        if(vKode != "" && vNama != ""){
                            ...
                            var vReqSimpanData = $.ajax({
                                ...
                                data: { dtOperasi: vOperasi, 
                                    ...
                                    dtNama : vNama,
                                    dtCatatan: vCatatan,
                                    dtKodeDepartemen: vKodeDepartemen,
                                    dtKodePekerjaan: vKodePekerjaan,
                                    dtTanggalMasuk: vTanggalMasuk,
                                    dtTanggalBerhenti: vTanggalBerhenti,
                                    dtAktif: vAktif
                                },
                                dataType: "html"
                            });
                    ...
                    $('#idKodeOrang').click(function(e){
                        ...
                        Custombox.open({
                            target: '${URLModAdmin}/modSipilModalOrang/modal.jsp?o=t&w=' + vWaktu,
                            effect: 'slide',
                            animation: 'top,top',
                            overlayClose: false
                        });

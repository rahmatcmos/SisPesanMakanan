...
<%
    ...
    if(vGetOperasi.equals("u")){
        ...
        ResultSet vArrHasil = oOpsBasisdata.fArrAmbilDataDbKondisi("", 
                "", 
                vModKonfNamaTabel, 
                new String[]{"kode","nama","catatan","kode_geo_provinsi"}, 
        ...
        vKodeNegara = oOpsBasisdata.fAmbilSatuData("", "", "tb_geo_provinsi", "kode_geo_negara", "kode", vKodeProvinsi);
        /* gambar icon */
    ...
    if(vGetOperasi.equals("t") || vGetOperasi.equals("u")){
        ...
        vHTMLForm = oForm.fForm("POST", "#", 
            new String[]{"Kode", "Nama " + vModKonfNamaData,"Negara","Provinsi","Catatan"}, 
            new String[]{"!Kode", "Nama","KodeNegara","KodeProvinsi","Catatan"}, 
            new String[]{"@t","@t","s","s","a"}, 
            new String[]{vKode,vNama,vSelNegara,vSelProvinsi,vCatatan}, 
...
<%@ taglib tagdir="/WEB-INF/tags/desain/standar/halaman/admin/modul/modGeopolitikKabupaten" prefix="admin" %>
<admin:modal>
